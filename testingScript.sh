...
do
	...
	#llvm-profdata merge -sparse ./coverage/${lastTest}.profdata ./quadrilateralClassifier.profraw -o ./coverage/${currentTest}.profdata
  	llvm-profdata merge -sparse ${lastTest}.profraw ${currentTest}.profraw -o ./coverage/${currentTest}.profdata
	lastTest=${currentTest}
done

#show code coverage
llvm-cov show ./quadrilateralClassifier -instr-profile=quadrilateralClassifier.profdata main.cpp Errors.cpp FilterFunctions.cpp ParallelAndCongruentFunctions.cpp
